...
class TestTransfer(unittest.TestCase):
    ...
    def test_successful_transfer(self):
        self.svc.transfer(self.acc1, self.acc2, 5000, 1234)
    ...
    def test_insufficient_balance(self):
        with self.assertRaises(InsufficientBalanceException):
            self.svc.transfer(self.acc1, self.acc2, 95000, 1234)

    def test_daily_transfer_limit_breach(self):
        self.svc.transfer(self.acc1, self.acc2, 20000, 1234)
        self.svc.transfer(self.acc1, self.acc2, 20000, 1234)
    ...
    def test_remaining_limit(self):
        self.svc.transfer(self.acc1, self.acc2, 10000, 1234)
